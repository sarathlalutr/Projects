<%@ Page Title="" Language="C#" MasterPageFile="~/NBADMasterPage.Master" AutoEventWireup="true" CodeBehind="LocationReport.aspx.cs" Inherits="NBAD.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        ...
        <fieldset>
             ...
             <div>
       <label>Select Location</label> <asp:DropDownList ID="drpLocation" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpLocation_SelectedIndexChanged">
        </asp:DropDownList>
