<%@ Page Title="" Language="C#" MasterPageFile="~/NBADMasterPage.Master" AutoEventWireup="true" CodeBehind="departmentEntry.aspx.cs" Inherits="NBAD.WebForm8" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/NBAD/Validations/DepartmentEntry.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                      ...
                      <div class="dataupload_bg ma">
                        <ul>
                            <li>
                                ...
                                <div class="w100p fl">
                                              <label>Department Name</label><div class="cb1"></div><asp:TextBox ID="txtDepartmentName" runat="server"></asp:TextBox> <span class="mandatory_inner">* </span> <div class="cb10"></div>  
                                </div>
                             </li>
    ...
    <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click"  OnClientClick="return DepartmentEntry();" CssClass="submit fr" Style="background-color: #006533; width: auto; padding-left: 60px; padding-right: 60px;" />
    </div>
                            </div> 
                    <div class="cb10"></div><div class="cb10"></div>
    ...
    <div class="clear"></div>
                     ...
                     <asp:GridView ID="gridDepartment" EmptyDataText="No Records Found" runat="server" AutoGenerateColumns="False" BorderWidth="0"
                                AllowPaging="true" ShowFooter="false" PageSize="15" Width="100%" OnPageIndexChanging="gridDepartment_PageIndexChanging"
                                CssClass="mGrid" OnRowDeleting="gridDepartment_RowDeleting"
                                OnRowCommand="gridDepartment_RowCommand">
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="Department Name">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <a class="aEdit" title="Edit" href='EditDepartment.aspx?Id=<%#Eval("DepartmentId") %>'>Edit</a>
                                        </ItemTemplate>
                                        <HeaderStyle Width="10%"></HeaderStyle>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkDelete" CssClass="aDelete" ToolTip="Delete" runat="server" CommandName="delete" OnClientClick=' javascript:return confirm("Are you sure you want to delete?"); '
                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem, "DepartmentId") %>'>Delete</asp:LinkButton>
