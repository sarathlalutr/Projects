...
namespace NBAD
{
    public partial class WebForm13 : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                var bra = drpBranch.SelectedValue;
                var conObj = new DBConnection();
                ...
                DataTable dt = repObj.allSwipeReport(fromdate, todate,drpBranch.SelectedValue, drpEmployeeId.SelectedItem.Text);
                if (dt == null)
                {
                ...
                else
                {
                    ...
                    PdfCreater.ExportToPdf(dt, "All Swipe Report", subHeading);
                }
