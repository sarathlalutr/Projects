<%@ Page Title="" Language="C#" MasterPageFile="~/NBADMasterPage.Master" AutoEventWireup="true" CodeBehind="PunctualityReport.aspx.cs" Inherits="NBAD.WebForm16" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/NBAD/Validations/PunctualityReport.js"></script>
    <script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                     ...
                     <div class="dataupload_bg ma">
                        <ul>
                            <li style="">
                                ...
                                <div class="w100p fl">
        <label>Branch</label> <div class="cb1"></div><asp:DropDownList ID="drpBranch" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpBranch_SelectedIndexChanged"></asp:DropDownList><span class="mandatory_inner">* </span><div class="cb10"></div>                                                  
    <label>EmployeeNo</label> <div class="cb1"></div>
    <asp:DropDownList ID="drpEmployeeId" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpEmployeeId_SelectedIndexChanged"></asp:DropDownList><span class="mandatory_inner">* </span>  <div class="cb10"></div> 
                          <label>select Date</label> <div class="cb1"></div><asp:TextBox ID="txtFromDate" runat="server"></asp:TextBox> <span class="mandatory_inner">* </span><div class="cb10"></div>
    <%--<label>To</label>--%><asp:TextBox ID="txtToDate" runat="server" Visible="False"></asp:TextBox>                   
                                </div>
                             </li>
    ...
    <label>Branch</label> <div class="cb1"></div><asp:TextBox ID="txtBranch" runat="server"></asp:TextBox>
  <div class="cb10"></div>
                                    </div>
                            </li>
                        </ul>
    ...
    <asp:Button ID="btnSubmit" runat="server" Text="Generate Report" OnClientClick=" return PunctualityReport(); " OnClick="btnSubmit_Click" CssClass="submit fr" Style="background-color: #006533; width: auto; padding-left: 60px; padding-right: 60px;" />
